...
<div
    style=" font-family:'times_new_roman, DejaVu Sans, sans-serif;';font-size: 14px;border: 1px solid black; margin:3%; padding: 2%; border-radius: 2px; background-color: whitesmoke">
    @include('appeals_pdf_templates.appeal_header')
    <div style="font-size: 14px;">
        <p><br></p>
        <p style=";text-align: center;"><strong>Частично досрочное погашение</strong></p>
        <p style="text-align: center;"><strong>&nbsp;</strong></p>
        <p style="text-align: center;font-size: 14px"><strong>ЗАЯВЛЕНИ</strong></p>
        <p>&nbsp;</p>
