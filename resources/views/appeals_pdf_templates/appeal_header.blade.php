<div style="font-size: 14px">
    ...
    <p style="text-align: right;margin-bottom: 5px;">ФИО&nbsp;<u>{{$user->name??""}}</u></p>
    <p style="text-align: right;margin-bottom: 5px;">ИИН&nbsp;<u>{{$user->iin??""}}</u></p>
    <p style="text-align: right;margin-bottom: 5px;">Сот.&nbsp;<u>{{$user->mobile??""}}</u></p>
    <p style="text-align: right;margin-bottom: 5px;">E-mail &nbsp;<u>{{$user->email??""}}</u></p>
    <p><br></p>
</div>
