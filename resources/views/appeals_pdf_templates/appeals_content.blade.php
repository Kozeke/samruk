...
<div v-if="selected_code_id">
    ...
    <div class="page">
        ...
        <div v-if="selected_code_id==3" class="content">
            <div>
                ...
                <p class="appeal-text">&nbsp;
                    ...
                    90% начисленной пени арендуемого мною помещения, расположенного по адресу: {{$data['JK']??""}}
                    согласно
        ...
        <div v-if="selected_code_id==5" class="content">
            ...
            <p style="font-size: 18px; text-align: center"><strong>ЗАЯВЛЕНИЕ</strong></p>
            <p class="appeal-text">
                Прошу Вас предоставить справку о задолженности в целях полного погашения остатка стоимости арендуемого
                мною жилого помещения, расположенного по адресу: {{$data['JK']??""}}
                согласно условий Договора аренды с выкупом жилого помещения от {{$data['date_d']??""}} года №{{$id??""}}
        ...
        <div v-if="selected_code_id==4" class="content">
            <p><br></p>
            <p style="font-size: 18px; text-align: center"><strong>Частично досрочное погашение за счет
                    ЕПВ&nbsp;</strong></p>
            <p>&nbsp;</p>
            <p style="font-size: 18px; text-align: center"><strong>ЗАЯВЛЕНИЕ</strong></p>
            <p style="text-indent: 45px">Прошу Вас предоставить справку о задолженности в целях частично досрочного
                погашения остатка стоимости
                арендуемого мною жилого помещения, расположенного по адресу: {{$data['JK']??""}}
                согласно условий Договора аренды с выкупом жилого помещения от {{$data['date_from']??""}} года
                № {{$id??""}}
        ...
        <div v-if="selected_code_id==6" class="content">
            ...
            <p>&nbsp;</p>
            <p class="appeal-text">Настоящим прошу Вас предоставить справку о всех поступивших платежах по Договору
                аренды с выкупом
        ...
        <div v-if="selected_code_id==7" class="content">
            ...
            <p class="appeal-text">Прошу Вас разрешить сдать в субаренду арендуемое мною жилое помещение, расположенное
                по адресу
                {{$data['JK']??""}}, согласно условий Договора аренды с выкупом жилого помещения
                от {{$data['date_d']??""}}
                №{{$id??""}} в связи с
            </p>
        ...
        <div v-if="selected_code_id==10" class="content">
            <div style="margin-bottom: 25px; text-align: center">
                <span v-if="lock_inputs">@{{appeal_title}}</span>
                <span v-else>
            <input placeholder="Тема" v-model="appeal_title">
                </span>
            </div>
            <span v-if="lock_inputs">@{{appeal_text}}</span>
            <span v-else>
