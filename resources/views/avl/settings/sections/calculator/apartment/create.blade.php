...
@section('main')
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ url('/admin/settings/sections/'.$section->id.'/calculator/'.$complex->id.'/apartment') }}" method="post" id="submit">
          {!! csrf_field(); !!}
                ...
                <div class="row">
	                  ...
	                  <div class="col-3">
	                    <div class="form-group">
	                      ...
	                      <input type="text" class="form-control" name="apartment_name_{{ $lang->key }}" value="">
	                    </div>
	                  </div>
									@endforeach
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="apartment_measure" value="">
                    </div>
                  </div>
                </div>
